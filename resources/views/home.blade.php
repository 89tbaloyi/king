  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3">King Motor spares</div>
      </a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseBootstrap" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="alerts.html">Transmission</a>
            <a class="collapse-item" href="buttons.html">Engine</a>
            <a class="collapse-item" href="dropdowns.html">Wheels</a>
            <a class="collapse-item" href="modals.html">Accessories</a>
            <a class="collapse-item" href="popovers.html">Intereior</a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTable" class="collapse" aria-labelledby="headingTable" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Tow Truck Service</h6>
            <a class="collapse-item" href="{{route('tows.index')}}"> T Truck Collection</a>
      ...
      <li class="nav-item">
        ...
        <div id="collapsePage" class="collapse" aria-labelledby="headingPage" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="login.html">Product deliveries</a>
            <a class="collapse-item" href="register.html">Current Projects</a>
